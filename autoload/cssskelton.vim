...
if !exists('g:cssskelton_autoyank')
...
if !exists('g:cssskelton_register')
    let g:cssskelton_register = ''
endif
            ...
            if tags != []
                ...
                if chk == []
                    ...
                    if chk == []
                        ...
                        let tag_nest = cssskelton#getTagProp(tag_name)
...
function! cssskelton#CssSkeltonMono()
    ...
    let tags = matchlist(line, '\v(.{-})(\<)(.{-})(\>)(.*)')
    if tags != []
        let tag = cssskelton#getTagProp(tags[3])
    endif
...
function! cssskelton#getSelecterPhrase(obj)
    let tag = a:obj.tag
